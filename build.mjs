// Production build for the VM Manager extension.
//
// What ships is one file: `lib/vm.dex`, the extension's own code, drawn by JCode's Compose runtime
...
copyFileSync(DEX, 'lib/vm.dex');

console.log('✓ built native/ → lib/vm.dex');
